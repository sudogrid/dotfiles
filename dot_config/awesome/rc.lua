...
local youtube      = "freetube"
local password     = "1password"

awful.util.terminal = terminal
awful.util.tagnames = { "dev", "www", "vim", "kvm", "file" }
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "y", function () awful.spawn(youtube) end,
              {description = "run youtube", group = "launcher"}),

    awful.key({ modkey }, "p", function () awful.spawn(password) end,
              {description = "run 1password", group = "launcher"}),
